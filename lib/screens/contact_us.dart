              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                            'Εάν ενδιαφέρεστε για υιοθεσία ή φιλοξενία, παρακαλούμε συμπληρώστε την αντίστοιχη φόρμα στην αγγελία του σκύλου που σας ενδιαφέρει από την '),
                    TextSpan(
                      text: 'λίστα υιοθεσιών.\n\n',
                      style: TextStyle(
